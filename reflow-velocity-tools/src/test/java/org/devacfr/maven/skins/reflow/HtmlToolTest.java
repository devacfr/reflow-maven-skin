...
public class HtmlToolTest extends TestCase {
  ...
  public void shouldReorderToTopOneSection() {
    verify(content -> htmlTool.reorderToTop(content, "a:has(img), img", 1, "<div class=\"caption\"></div>"), "html");
  }
  ...
  public void shouldReplaceWith() {
    ...
    assertEquals("<p>text <code class=\"literal\">foo value</code> end text.</p>",
        actual);
  }
  ...
  public void shouldEnsureHeadingIds() {
    verify(content -> htmlTool.ensureHeadingIds("page", "overview", content, HtmlTool.DEFAULT_SLUG_SEPARATOR), "html");
  }

  @Test
  public void shouldEnsureHeadingIdsForFrame() {
    verify(content -> htmlTool.ensureHeadingIds("frame", "overview", content, HtmlTool.DEFAULT_SLUG_SEPARATOR), "html");
  }
