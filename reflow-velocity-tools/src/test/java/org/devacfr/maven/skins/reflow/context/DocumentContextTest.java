...
public class DocumentContextTest extends MockitoTestCase {
  ...
  public void shouldBuildDocumentContext() throws Exception {
    ...
    assertEquals("sidenav-enabled", navSideMenu.getCssOptions());

    assertEquals("anchorjs-enabled scrolltop-smooth-enabled sidenav-enabled", documentContext.getCssOptions());
