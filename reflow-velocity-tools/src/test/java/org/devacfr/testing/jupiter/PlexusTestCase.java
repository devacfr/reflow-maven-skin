...
public abstract class PlexusTestCase extends TestCase {
   ...
   * have a test class called org.foo.FunTest, then this will produce a resource name of org/foo/FunTest.xml which would
   * be used to configure the Plexus container before running your test.
   *
   * @param subname
   *          the subname
